...
exports.switchManyTasks = exports.switchTasks = exports.withNewTask = exports.clone = void 0;
...
var switchTasks = function (t, taskId) { return ({
    id: t.id,
    name: t.name,
...
var switchManyTasks = function (t, taskIds) { return taskIds
    .reduce(function (acc, tId) { return (0, exports.switchTasks)(t, tId); }, t); };
